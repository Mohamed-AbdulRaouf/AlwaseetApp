...
struct ContentView: View {
    ...
    var onboardingDataArray: [OnboardingModel] = [
        ...
        OnboardingModel(id: 3, image: "cameras", titleText: "Training and Tutorial", descriptionText: "Best training and tutorial collections for activities."),
        OnboardingModel(id: 4, image: "camping", titleText: "Dream Equipments", descriptionText: "Go through some of our best collections of hiking/surfing gear and more", showButton: true)
    ]
...
//                Spacer(minLength: 20)
                ...
                if self.onboardingData.showButton ?? false {
                    VStack {
                        Button(action: {
                            Constants.shared.isOnboardShow = true
