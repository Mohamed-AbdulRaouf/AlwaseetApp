...
//                    Stepper("Slide: \(index + 1)", value: $index.animation(.easeInOut), in: 0...images.count-1)
//                        .font(Font.body.monospacedDigit())
            ...
            .fullScreenCover(isPresented: self.$loggedIn, onDismiss: nil) {
                LogInView()
            }
        }
    }
